...
def generate_MDA_problem_inputs_files(roads: StreetsMap):
    inputs = [
        generate_MDA_problem_input(
            ...
            choosing_junctions_seed=0x5739575,
        ...
        generate_MDA_problem_input(
            ...
            choosing_junctions_seed=0x5739574,
            limit_to_radius=6000,
            nr_reported_apartments=14,
            nr_laboratories=6,
            ambulance_taken_tests_storage_capacity=8,
            initial_nr_matoshim_on_ambulance=4,
            nr_roommates_options=(1, 2, 3, 4),
            nr_roommates_probabilities=(0.2, 0.4, 0.3, 0.1),
            nr_free_matoshim_in_lab_options=(6, 7, 8, 9, 10),
